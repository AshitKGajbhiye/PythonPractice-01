# football_competition_winner's_goals_hackerrank.py
# https://github.com/ejaj/rest-api-intermediate/blob/main/football_competition_winner's_goals_hackerrank.py
...
def getWinnerTotalGoals(competition_name, year):
    ...
    print("competition_request: ", competition_request)
